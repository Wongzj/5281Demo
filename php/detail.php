...
function addCar($conn){
	$sql = "SELECT * FROM car WHERE id='{$_GET['pid']}' AND userId = '{$_GET['userId']}'";
	 ...
	 if($row == TRUE){
		...
		$sql4 = "INSERT INTO car (userId,id,name,price,description,img,p_class,p_specification,p_num)
		VALUES ('{$_GET['userId']}', '{$_GET['pid']}','{$_GET['name']}','{$_GET['price']}','{$_GET['description']}','{$_GET['img']}','{$_GET['p_class']}','{$_GET['p_specification']}',1)";
...
function addOrder($conn){
	...
	if($row == TRUE){
		...
		$sql = "INSERT INTO my_order (userId,id,p_name,price,description,my_address,img,p_class,consignee,mobile,p_specification,orderDate,orderCode,actual_price,userName)
		VALUES ('{$_GET['userId']}','{$_GET['pid']}','{$_GET['p_name']}','{$_GET['price']}','{$_GET['description']}','{$_GET['my_address']}','{$_GET['img']}','{$_GET['p_class']}','{$_GET['user_name']}','{$_GET['user_mobile']}','{$_GET['p_specification']}','{$_GET['orderDate']}','{$_GET['orderCode']}','{$_GET['shifu']}','{$_GET['userName']}')";
